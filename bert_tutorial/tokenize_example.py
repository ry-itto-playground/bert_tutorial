...
bert_tokenizer: PreTrainedTokenizer = BertTokenizer.from_pretrained(
    'bert-base-cased')
...
encoded_test, token_type_ids, attention_mask = returned_dict[
    'input_ids'], returned_dict['token_type_ids'], returned_dict['attention_mask']
print("="*10)
...
print("\n 実際にトークナイズされたテキスト")
print("tokenized text: {}".format(
    bert_tokenizer.convert_ids_to_tokens(encoded_test[:10])))
print("="*10)
###
